...
public class scoop extends Applet 
{
	public BranchGroup createBranchGroupSceneGraph() 
{
    ...
    float[][][] P1={{{       +0.0f,+0.15f,+0.8f,1.f},
     ...
     color1.setColor(0.5f,0.4f,0.3f);
     app1.setColoringAttributes(color1);
        
     //
     float[][][] P2={{{      +0.0f,+0.15f,+0.8f,1.f},
                            {+0.0f,+0.25f,+0.4f,1.f},
                            {+0.0f,+0.35f,+0.4f,1.f},
                            {+0.0f,+0.45f,+0.8f,1.f}  },
            {               {-0.8f,+0.1f,+1.4f,1.f},
      ...
      color2.setColor(0.5f,0.6f,0.7f);
...
public scoop() {
        ...
        Panel p = new Panel();
    	p.add(new Label("name:cck,number:20151681310210  scoop"));
   ...
   {
	new MainFrame(new scoop(),400,400);
	}
   }
