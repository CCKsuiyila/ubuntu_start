...
public class E19 extends Applet {
        ...
        for(j=0;j<nn2+1;j++){
            ...
            for(i=1;i<nn1-1;i++) {
                for(j=0;j<nn2;j++){//
                    ...
                    Point3f C=new Point3f(spherexyz[i+1][j+1][0],spherexyz[i+1][j+1][1],spherexyz[i+1][j+1][2]);
