...
public class hopper_four extends Applet {
    ...
    public static void main(String argv[]) {
        new MainFrame(new hopper_four(), 800, 800);
    }
    ...
    class SurfaceDisplay extends Shape3D {
        ...
        Geometry createGeometry0(){
            ...
            //
            QuadArray SurfaceQuadArray=new QuadArray(3*n0*4, GeometryArray.COORDINATES|GeometryArray.NORMALS);
            c=0;//
            for(i=0;i<3;i++){
                for(j=0;j<n0;j++){
