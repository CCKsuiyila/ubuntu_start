...
public class BThreeOrderSurface extends Applet{
    public BranchGroup createBranchGroupSceneGraph(){
        ...
        Shape3D BControlPoints1=new BSurfaceControlPoints(P1,app2); 
    ...
    public static void main(String[] args){
        new MainFrame(new BThreeOrderSurface(),400,400);
    }
    
}

    class  BThreeOrderSurfaceface extends Shape3D{
        public BThreeOrderSurfaceface(float[][][] P,Appearance app){
            int i,j,k;
            ...
            for(i=0;i<n0+1;i++)
                for(j=0;j<n0+1;j++){
                    ...
                    SurfaceXYZ[i][j][0]=g3.CC[0][0]/36.f;
                    //计算一点的y坐标
                    ...
                    SurfaceXYZ[i][j][1]=g7.CC[0][0]/36.f;
                    //计算一点的z坐标
                    ...
                    SurfaceXYZ[i][j][2]=g11.CC[0][0]/36.f;
                    //计算一点的第4维坐标
                    ...
                    SurfaceXYZ[i][j][3]=g15.CC[0][0]/36.f;
    ...
    class  BSurfaceControlPoints extends Shape3D{
        public BSurfaceControlPoints(float[][][] P,Appearance app) {
            int i,j,k;
            QuadArray BsurfacecontrolPointsNet = new QuadArray(3*3*4,GeometryArray.COORDINATES|GeometryArray.NORMALS);
            int c=0;	
            for(i=0;i<3;i++){
                for(j=0;j<3;j++){
                    ...
                    n.cross(b, a);
                    n.normalize();
                    BsurfacecontrolPointsNet.setCoordinate(c, A);
                    BsurfacecontrolPointsNet.setCoordinate(c+1, B);
                    BsurfacecontrolPointsNet.setCoordinate(c+2, C);
                    BsurfacecontrolPointsNet.setCoordinate(c+3, D);
                    BsurfacecontrolPointsNet.setNormal(c, n);
                    BsurfacecontrolPointsNet.setNormal(c+1, n);
                    BsurfacecontrolPointsNet.setNormal(c+2, n);
                    BsurfacecontrolPointsNet.setNormal(c+3, n);
                    c=c+4;
                }
            }
            this.addGeometry(BsurfacecontrolPointsNet);
            this.setAppearance(app);
        }
    }
