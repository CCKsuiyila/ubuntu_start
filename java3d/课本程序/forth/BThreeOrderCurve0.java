...
public class BThreeOrderCurve0 extends Applet{ 
    public BranchGroup createBranchGroupSceneGraph(){
        ...
        Shape3D Bezier=new BThreeOrderCurve1();
    ...
    public static void main(String[] args){ 
        new MainFrame(new BThreeOrderCurve0(),400,400);
    }
}


//BezierCurve
class  BThreeOrderCurve1 extends Shape3D{
    public BThreeOrderCurve1(){
        int i,j,k;
        ...
        n=50;division=1.f/n;
        for(i=0;i<n+1;i++){u[i]=i*division;}	
        for(i=0;i<n+1;i++){
            UU[0][0]=1.f/6.f;
            UU[0][1]=u[i]/6.f;
            UU[0][2]=u[i]*u[i]/6.f;
            UU[0][3]=u[i]*u[i]*u[i]/6.f;
        ...
        for(k=0;k<n+1;k++){ 
            ...
            LineStripArray contralpointslines=new LineStripArray(4,LineArray.COORDINATES,contralpointscount);
            contralpointslines.setCoordinates(0,contralpoints);
            LineStripArray curvepointslines=new LineStripArray(100,LineArray.COORDINATES,curvepointscount);
